...
PRODUCT_PROFILES = {
    "sticker": {
        ...
        "raw_qa": ["semantic", "text_artifacts", "quality", "aesthetics", "bg_uniform", "separation"],
    ...
    "emoji": {
        ...
        "tab_image": (96, 74),
        "max_file_size_kb": 1000,
        "raw_qa": ["semantic", "expression", "composition", "text_artifacts", "quality", "aesthetics", "decorations", "bg_uniform", "separation"],
        "nobg_qa": ["bg_clean", "body_intact"],
        "format_qa": ["bg_clean", "quality"],
    },
}
